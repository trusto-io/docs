...
```json
{
  ...
  "outcome": {
    ...
    "ethocaID": "2L07DBRFGBDLIW7SH59V969JG",
    "status": "SUCCESS",
    "outcome": "other",
    "refunded": "refunded",
    "firstPartyFraud": "no",
...
| firstPartyFraud | string or null | Deprecated legacy field. |
| amountStopped | number or null | Deprecated or provider-specific stopped amount. |
