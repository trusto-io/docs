...
- Go do [https://app.trusto.io](https://app.trusto.io) - Settings - API Credentials
- Generate the API Key for your organization as Organization Owner

![Image](/images/image-2.png "Image")

- Make sure to save the API key, you will not be able to view it again
- Use the `X-API-KEY` header with your API Key value in your requests
